...
suite('Unit Tests', function(){
  ...
  suite('Function convertHandler.getNum(input)', function() {
    ...
    test('Fractional Input', function(done) {
      var input = '1/3mi';
      assert.equal(Number(convertHandler.getNum(input)),1/3);
      done();
    });
    
    test('Fractional Input w/ Decimal', function(done) {
      var input = '1.5/3kg';
      assert.equal(Number(convertHandler.getNum(input)),1.5/3);
      done();
    });
    
    test('Invalid Input (double fraction)', function(done) {
      var input = '1.5.1L';
      assert.notTypeOf(Number(convertHandler.getNum(input)),'number');
      done();
    });
